...
use App\Filament\Resources\Youth8Resource\Pages;
use App\Filament\Resources\Youth8Resource\RelationManagers;
...
class Youth8Resource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Lagang';
    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';
    protected static ?int $navigationSort = 8;

    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()->where('purok', 'Lagang');
    }
    ...
    {
        return [
            'index' => Pages\ListYouth8s::route('/'),
            'create' => Pages\CreateYouth8::route('/create'),
            'edit' => Pages\EditYouth8::route('/{record}/edit'),
        ];
    }
}
