...
use App\Filament\Resources\Youth6Resource\Pages;
use App\Filament\Resources\Youth6Resource\RelationManagers;
...
class Youth6Resource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Sigay';
    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';
    protected static ?int $navigationSort = 6;

    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()->where('purok', 'Sigay');
    }
    ...
    {
        return [
            'index' => Pages\ListYouth6s::route('/'),
            'create' => Pages\CreateYouth6::route('/create'),
            'edit' => Pages\EditYouth6::route('/{record}/edit'),
        ];
    }
}
