...
use App\Filament\Resources\Youth4Resource\Pages;
use App\Filament\Resources\Youth4Resource\RelationManagers;
...
class Youth4Resource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Lampisaw';
    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';
    protected static ?int $navigationSort = 4;

    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()->where('purok', 'Lampisaw');
    }
    ...
    {
        return [
            'index' => Pages\ListYouth4s::route('/'),
            'create' => Pages\CreateYouth4::route('/create'),
            'edit' => Pages\EditYouth4::route('/{record}/edit'),
        ];
    }
}
