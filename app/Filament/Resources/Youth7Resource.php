...
use App\Filament\Resources\Youth7Resource\Pages;
use App\Filament\Resources\Youth7Resource\RelationManagers;
...
class Youth7Resource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Tahong';
    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';
    protected static ?int $navigationSort = 7;

    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()->where('purok', 'Tahong');
    }
    ...
    {
        return [
            'index' => Pages\ListYouth7s::route('/'),
            'create' => Pages\CreateYouth7::route('/create'),
            'edit' => Pages\EditYouth7::route('/{record}/edit'),
        ];
    }
}
