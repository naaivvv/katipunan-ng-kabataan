...
use App\Filament\Resources\Youth2Resource\Pages;
use App\Filament\Resources\Youth2Resource\RelationManagers;
...
class Youth2Resource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Bay-ad';
    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';
    protected static ?int $navigationSort = 2;

    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()->where('purok', 'Bay-ad');
    }
    ...
    {
        return [
            'index' => Pages\ListYouth2s::route('/'),
            'create' => Pages\CreateYouth2::route('/create'),
            'edit' => Pages\EditYouth2::route('/{record}/edit'),
        ];
    }
}
