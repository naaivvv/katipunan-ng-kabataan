...
use App\Filament\Resources\Youth5Resource\Pages;
use App\Filament\Resources\Youth5Resource\RelationManagers;
...
class Youth5Resource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Greenshell';
    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';
    protected static ?int $navigationSort = 5;

    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()->where('purok', 'Greenshell');
    }
    ...
    {
        return [
            'index' => Pages\ListYouth5s::route('/'),
            'create' => Pages\CreateYouth5::route('/create'),
            'edit' => Pages\EditYouth5::route('/{record}/edit'),
        ];
    }
}
